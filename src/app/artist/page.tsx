  ...
  return (
    <div className="space-y-6 max-w-[1200px] mx-auto">
      <header className="relative panel p-8 overflow-hidden shadow-2xl border border-edge flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
        ...
        <div className="relative z-10">
          <h1 className="text-4xl font-extrabold tracking-tighter text-transparent bg-clip-text bg-gradient-to-r from-white to-white/60 flex items-center gap-3">
            Song Studio
            {audius?.verified && <span className="text-[11px] uppercase tracking-widest text-black bg-neon px-2 py-0.5 rounded shadow-[0_0_10px_rgba(0,229,114,0.5)] font-bold">Verified Artist</span>}
      ...
      <section className="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <Stat k="Cumulative Revenue" v={formatCryptoWithFiat(artistRevenue, "SOL", artistRevenue * solUsdRate, currency, 4)} accent="gain" tooltip={`Total SOL you have earned from retained artist allocation and platform activity. ${priceAgeText(fiatUpdatedAt)}.`} />
