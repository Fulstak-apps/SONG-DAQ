export function pickAudiusArtwork(input: any, fallback?: string | null): string | null {
  const candidates = [
    ...
    input?.user?.profile_picture?.["1000x1000"],
    input?.user?.profile_picture?.["480x480"],
    input?.user?.profile_picture?.["150x150"],
    input?.user?.profilePicture?.["1000x1000"],
    input?.user?.profilePicture?.["480x480"],
    input?.user?.profilePicture?.["150x150"],
