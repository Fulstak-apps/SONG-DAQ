  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        className="mobile-safe-overlay fixed inset-0 z-[9500] grid items-start justify-items-center overflow-y-auto bg-black/70 backdrop-blur-xl sm:place-items-center overscroll-contain"
        onClick={onClose}
